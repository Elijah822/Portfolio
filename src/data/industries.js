    ...
    projects: [
      {
        ...
        impact: "€50M+ exposure avoided", accent: "#c9aa7c",
      ...
      },
      {
        ...
        url: null,
        desc: "Founder-led product. Designed 4 interface variants (kiosk, cashier, handheld, mobile) for a retail self-checkout system deployed to 400+ locations, reducing average checkout time by 60%.",
        metrics: [
        ...
        about: "Full disclosure: I'm the founder & CEO of QueuePay Africa — this is my own venture, not a third-party client engagement. Multi-surface design challenge: each variant (customer kiosk, cashier dashboard, handheld scanner, mobile app) had different users, contexts, and constraints. Full customer-facing launch still in progress.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        year: "2023", status: "shipped", statusLabel: "Shipped",
        ...
        metrics: [
          ...
          { value: "8-10", label: "Applications tracked / month" },
        ],
        role: "Lead UX/Product Designer",
        about: "Designed the full product experience from sign-up through daily use, including the AI assistant integration that became the product's core differentiator.",
      },
      {
        id: "07", title: "Svar.se",
